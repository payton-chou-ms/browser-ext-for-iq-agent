(function initIQPanelTasks(global) {
  ...
  function renderTasksList() {\n    // Get tool calls from active chat tab or fallback to chat state\n    const activeTab = root.chatTabs?.getActiveTab?.();\n    const chatState = root.chat?.getState?.() || {};\n    const toolCalls = activeTab?.toolCalls || chatState.toolCalls || [];
