...
(function initIQChatTabs(global) {
  ...
  /** Debounced save - coalesces rapid updates (e.g., streaming) */
  ...
  function switchTab(tabId) {
    ...
    scheduleSave();  // Debounced - not critical for immediate persist
  ...
  function updateTab(tabId, updates) {
    ...
    scheduleSave();  // Debounced - high-frequency during streaming
